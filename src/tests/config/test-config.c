...
test_config_simple (void)
{
	...
	g_assert_cmpint (nm_config_data_get_connectivity_interval (nm_config_get_data (config)), ==, 100);
...
test_config_override (void)
{
	...
	g_assert_cmpstr (nm_config_get_dhcp_client (config), ==, "dhclient");
	g_assert_cmpstr (nm_config_get_log_level (config), ==, "INFO");
	g_assert_cmpint (nm_config_data_get_connectivity_interval (nm_config_get_data (config)), ==, 12);
...
test_config_confdir (void)
{
	...
	g_assert_cmpstr (nm_config_data_get_connectivity_uri (nm_config_get_data (config)), ==, "http://example.net");
	g_assert_cmpint (nm_config_data_get_connectivity_interval (nm_config_get_data (config)), ==, 100);
