...
#define NM_IFCFG_CONNECTION_LOG_ARG(con)    NM_IFCFG_CONNECTION_LOG_PATH (nm_ifcfg_connection_get_path (con)), nm_connection_get_uuid ((NMConnection *) con), nm_connection_get_id ((NMConnection *) con)
#define NM_IFCFG_CONNECTION_LOG_FMTD        "%s (%s,\"%s\",%p)"
#define NM_IFCFG_CONNECTION_LOG_ARGD(con)   NM_IFCFG_CONNECTION_LOG_PATH (nm_ifcfg_connection_get_path (con)), nm_connection_get_uuid ((NMConnection *) con), nm_connection_get_id ((NMConnection *) con), (con)
